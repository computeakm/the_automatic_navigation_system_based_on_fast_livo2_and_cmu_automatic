...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('sensor_model/miss', default_value='0.1'),
        ...
        DeclareLaunchArgument('pointcloud_min_x', default_value='-100.0'),
        DeclareLaunchArgument('pointcloud_max_x', default_value='100.0'),
        DeclareLaunchArgument('pointcloud_min_y', default_value='-100.0'),
        DeclareLaunchArgument('pointcloud_max_y', default_value='100.0'),
        DeclareLaunchArgument('pointcloud_min_z', default_value='-0.5'),
        DeclareLaunchArgument('pointcloud_max_z', default_value='1.5'),
