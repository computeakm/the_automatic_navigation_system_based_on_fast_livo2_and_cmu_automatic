...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('frame_id', default_value='aft_mapped'),
        DeclareLaunchArgument('base_frame_id', default_value='camera_init'),
        DeclareLaunchArgument('height_map', default_value='False'),
        DeclareLaunchArgument('colored_map', default_value='True'),
        DeclareLaunchArgument('color_factor', default_value='0.6'),
        ...
        DeclareLaunchArgument('sensor_model/max_range', default_value='3.8'),
        DeclareLaunchArgument('sensor_model/hit', default_value='0.7'),
        DeclareLaunchArgument('sensor_model/miss', default_value='0.2'),
        DeclareLaunchArgument('sensor_model/min', default_value='0.3'),
        DeclareLaunchArgument('sensor_model/max', default_value='0.7'),
