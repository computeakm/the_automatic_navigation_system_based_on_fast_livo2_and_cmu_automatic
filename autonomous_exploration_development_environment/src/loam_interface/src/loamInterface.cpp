...
public:
  ...
  : Node("loamInterface")
  {
    ...
    pubLaserCloud = this->create_publisher<sensor_msgs::msg::PointCloud2>("/registered_scan", 2);
    pubOdometry = this->create_publisher<nav_msgs::msg::Odometry>("/state_estimation", 2);
