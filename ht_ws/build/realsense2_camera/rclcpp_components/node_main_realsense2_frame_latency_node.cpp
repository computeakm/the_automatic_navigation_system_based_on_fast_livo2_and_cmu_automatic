...
#define NODE_MAIN_LOGGER_NAME "realsense2_frame_latency_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rs2_ros::tools::frame_latency::FrameLatencyNode>";
